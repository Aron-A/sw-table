...
class AnimalTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    var filterData = [Animal]()
    
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        animals = AnimalDAO.getAnimalList()
        filterData = AnimalDAO.getAnimalList()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let animalCell = cell as? AnimalTableViewCell{
            ...
            let animal = filterData[indexPath.row]
            
            animalCell.animalName.text = animal.name
            animalCell.animalSpecie.text = animal.specie
            animalCell.animalImage.image = UIImage(named: animal.imageName)
